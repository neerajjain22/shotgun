...
- `content/blog/`: published Markdown blog posts generated by the content pipeline
- `seo/`: metadata, structured data, sitemap, robots helpers
- `heykrish-content/`: automated article generation workspace (Anthropic + queue + scheduler support)
...
Copy must follow clarity-first and ICP-focused guidance defined in `SEO_RULES.md`.
